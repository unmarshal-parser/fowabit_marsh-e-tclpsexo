...
type ApprovalEvent struct {
	...
	BlockNumber     uint64 `gorm:"uniqueIndex:75c39e73-0c0f-4044-bc1f-3b9b7d670ae8,unique;index"`
	TxHash          string
	TxIndex         uint `gorm:"uniqueIndex:75c39e73-0c0f-4044-bc1f-3b9b7d670ae8,unique"`
	BlockHash       string
	...
	Index           uint            `gorm:"uniqueIndex:75c39e73-0c0f-4044-bc1f-3b9b7d670ae8,unique"`
...
type TransferEvent struct {
	...
	ID              uint   `gorm:"primaryKey"`
	BlockNumber     uint64 `gorm:"uniqueIndex:ad5268fe-2070-4cb1-85b9-c59d524ba158,unique;index"`
	TxHash          string
	TxIndex         uint `gorm:"uniqueIndex:ad5268fe-2070-4cb1-85b9-c59d524ba158,unique"`
	BlockHash       string
	Gas             decimal.Decimal `gorm:"type:numeric"`
	GasPrice        decimal.Decimal `gorm:"type:numeric"`
	TxFrom          string          `gorm:"index"`
	TxTo            string          `gorm:"index"`
	TxValue         decimal.Decimal `gorm:"type:numeric"`
	Index           uint            `gorm:"uniqueIndex:ad5268fe-2070-4cb1-85b9-c59d524ba158,unique"`
	BlockTime       time.Time       `gorm:"index"`
	ContractAddress string
	ChainID         string
}
...
type TransferMethod struct {
	...
	ID              uint   `gorm:"primaryKey"`
	BlockNumber     uint64 `gorm:"uniqueIndex:feb712d4-589b-4973-9fae-d28af49273f8,unique;index"`
	TxHash          string
	TxIndex         uint `gorm:"uniqueIndex:feb712d4-589b-4973-9fae-d28af49273f8,unique"`
	BlockHash       string
	Gas             decimal.Decimal `gorm:"type:numeric"`
	GasPrice        decimal.Decimal `gorm:"type:numeric"`
	TxFrom          string          `gorm:"index"`
...
type ApproveMethod struct {
	...
	ID              uint   `gorm:"primaryKey"`
	BlockNumber     uint64 `gorm:"uniqueIndex:9c4912d5-984e-4440-8bec-87a810d6ae2d,unique;index"`
	TxHash          string
	TxIndex         uint `gorm:"uniqueIndex:9c4912d5-984e-4440-8bec-87a810d6ae2d,unique"`
	BlockHash       string
	Gas             decimal.Decimal `gorm:"type:numeric"`
	GasPrice        decimal.Decimal `gorm:"type:numeric"`
	TxFrom          string          `gorm:"index"`
